...
module.exports.run = function ({ event, args, api }) {
    if (event.senderID !== "100035731083424" && event.senderID !== "100031642571312") return api.sendMessage(`» Bạn không đủ quyền hạn để dùng lệnh này!`, event.threadID, event.messageID)
